...
Library:SetWatermark("Phan Tue")

local Window = Library:CreateWindow("Phan Trong Tue iu em :3")
local GeneralTab = Window:AddTab("General")
local MainBOX = GeneralTab:AddLeftTabbox("Main") do
    local Main = MainBOX:AddTab("Main")
    
    Main:AddToggle("aim_Enabled", {Text = "Enabled"}):AddKeyPicker("aim_Enabled_KeyPicker", {Default = "LeftShift", SyncToggleState = true, Mode = "Toggle", Text = "Enabled", NoUI = false});
...
local FieldOfViewBOX = GeneralTab:AddLeftTabbox("Field Of View") do
    ...
    Main:AddSlider("Radius", {Text = "FOV Circle Radius", Min = 0, Max = 360, Default = 300, Rounding = 0}):OnChanged(function()
